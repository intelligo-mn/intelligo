(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AnalyticsFrameComponent = /** @class */ (function () {
            ...
            AnalyticsFrameComponent.ctorParameters = function () { return [
            ...
            var CanActivateAnalyticsFrameComponent = /** @class */ (function () {
            ...
            CanActivateAnalyticsFrameComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _services_data_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../../services/data.service */ "./src/app/services/data.service.ts");
            var DeployLandingComponent = /** @class */ (function () {
                function DeployLandingComponent(el, snakbar, route, dataService) {
                    var _this = this;
                    this.el = el;
                ...
                DeployLandingComponent.prototype.loadSavedOptions = function () {
                    var key = ts_md5_dist_md5__WEBPACK_IMPORTED_MODULE_4__["Md5"].hashStr(JSON.stringify(this.dataService.chatServer.ServerUrl) + "|" + this.webOptions.businessId + "|" + this.webOptions.flowId);
            ...
            DeployLandingComponent.ctorParameters = function () { return [
            ...
            var HomeComponent = /** @class */ (function () {
                ...
                HomeComponent.prototype.userManagement = function () {
                    ...
                    this.loginService.performLogin(true, "/", true, function (done) {
                        if (!done) {
                            _this.infoDialog.alert("Login Required", "You must be logged in to your Chatbots.mn chat server to manage users");
                            return;
                        }
                ...
                HomeComponent.prototype.analytics = function () {
                    ...
                    this.loginService.performLogin(true, null, true, function (done) {
                        if (!done) {
                            _this.infoDialog.alert("Login Required", "You must be logged in to your Chatbots.mn chat server to view analytics");
                            return;
                        }
                        if (_this.dataService.loggedInUser) {
                            if (_this.dataService.isSuperAdmin()) {
                ...
                HomeComponent.prototype.deploy = function () {
                    ...
                    this.loginService.performLogin(true, null, true, function (done) {
                        if (!done) {
                            _this.infoDialog.alert("Login Required", "You must be logged in to your Chatbots.mn chat server to deploy your chatbot");
                            return;
                        }
                        if (_this.dataService.loggedInUser) {
                            if (_this.dataService.isSuperAdmin()) {
                ...
                HomeComponent.prototype.openAnalyticsPicker = function (params) {
                    var _this = this;
                    var d = this.dialog.open(_shared_business_picker_business_picker_component__WEBPACK_IMPORTED_MODULE_7__["BusinessPickerComponent"], {
                        width: '30%',
                        data: params
                    });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BizAccountsComponent = /** @class */ (function () {
                ...
                BizAccountsComponent.prototype.editBusinessAccount = function (data) {
                    var _this = this;
                    var d = this.dialog.open(_shared_edit_business_account_edit_business_account_component__WEBPACK_IMPORTED_MODULE_7__["EditBusinessAccountComponent"], {
                        width: '40%',
                        data: data
                    });
                    d.afterClosed().subscribe(function (x) {
                ...
                BizAccountsComponent.prototype.updateBusinessAccountStatus = function (account, status) {
                    var _this = this;
                    var work = (status == _models_data_models__WEBPACK_IMPORTED_MODULE_4__["BusinessAccountStatus"].ACTIVE ? "activate" : "deactivate");
            ...
            BizAccountsComponent.ctorParameters = function () { return [
                { type: _services_data_service__WEBPACK_IMPORTED_MODULE_5__["DataService"] },
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
            ...
            var CanActivateBizAccountComponent = /** @class */ (function () {
            ...
            CanActivateBizAccountComponent.ctorParameters = function () { return [
                { type: _services_data_service__WEBPACK_IMPORTED_MODULE_5__["DataService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UsersComponent = /** @class */ (function () {
                ...
                UsersComponent.prototype.createUserDialog = function () {
                    var _this = this;
                    var d = this.dialog.open(_shared_create_user_create_user_component__WEBPACK_IMPORTED_MODULE_7__["CreateUserComponent"], {
                        width: '60%',
                        data: {
                            bizId: this.bizId,
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _ngx_translate_core__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ngx-translate/core */ "./node_modules/@ngx-translate/core/fesm2015/ngx-translate-core.js");
            var AnaCloudSignupComponent = /** @class */ (function () {
                function AnaCloudSignupComponent(global, data, infoDialog, translate) {
                    this.global = global;
                    this.data = data;
                    this.infoDialog = infoDialog;
                    this.translate = translate;
            ...
            AnaCloudSignupComponent.ctorParameters = function () { return [
                { type: _services_globals_service__WEBPACK_IMPORTED_MODULE_3__["GlobalsService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppHeaderBarComponent = /** @class */ (function () {
            ...
            AppHeaderBarComponent.ctorParameters = function () { return [
                { type: _services_data_service__WEBPACK_IMPORTED_MODULE_4__["DataService"] },
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
                { type: _services_info_dialog_service__WEBPACK_IMPORTED_MODULE_5__["InfoDialogService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BusinessPickerComponent = /** @class */ (function () {
            ...
            BusinessPickerComponent.ctorParameters = function () { return [
                { type: _services_data_service__WEBPACK_IMPORTED_MODULE_2__["DataService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ChatServerManagerComponent = /** @class */ (function () {
            ...
            ChatServerManagerComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CreateChatbotComponent = /** @class */ (function () {
            ...
            CreateChatbotComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var EditBusinessAccountComponent = /** @class */ (function () {
            ...
            EditBusinessAccountComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GetAnaChatServerComponent = /** @class */ (function () {
                function GetAnaChatServerComponent(dialog) {
                    this.dialog = dialog;
                }
                ...
                GetAnaChatServerComponent.prototype.anaCloud = function () {
                    var d = this.dialog.open(_ana_cloud_signup_ana_cloud_signup_component__WEBPACK_IMPORTED_MODULE_3__["AnaCloudSignupComponent"], {
                        width: 'auto'
                    });
                };
                return GetAnaChatServerComponent;
            }());
            GetAnaChatServerComponent.ctorParameters = function () { return [
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginComponent = /** @class */ (function () {
                ...
                LoginComponent.prototype.managePublishServers = function () {
                    var _this = this;
                    var dialogRef = this.dialog.open(_chat_server_manager_chat_server_manager_component__WEBPACK_IMPORTED_MODULE_6__["ChatServerManagerComponent"], {
                        width: '60%',
                    });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _services_login_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../services/login.service */ "./src/app/services/login.service.ts");
            /* harmony import */ var _services_settings_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../services/settings.service */ "./src/app/services/settings.service.ts");
            var PublishChatbotComponent = /** @class */ (function () {
            ...
            PublishChatbotComponent.ctorParameters = function () { return [
                { type: _services_settings_service__WEBPACK_IMPORTED_MODULE_7__["SettingsService"] },
                { type: _services_globals_service__WEBPACK_IMPORTED_MODULE_4__["GlobalsService"] },
                { type: _services_data_service__WEBPACK_IMPORTED_MODULE_3__["DataService"] },
                { type: _services_login_service__WEBPACK_IMPORTED_MODULE_6__["LoginService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            PublishDialogComponent.ctorParameters = function () { return [
                { type: _services_settings_service__WEBPACK_IMPORTED_MODULE_3__["SettingsService"] },
                { type: _services_chatflow_service__WEBPACK_IMPORTED_MODULE_4__["ChatFlowService"] },
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] },
                { type: _services_info_dialog_service__WEBPACK_IMPORTED_MODULE_5__["InfoDialogService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ChatFlowComponent = /** @class */ (function () {
                function ChatFlowComponent(chatFlowService, dialog, infoDialog, route, router, dataService, loginService, snakbar, hotkeys, globalsService, simulatorService, settings) {
                    ...
                    this.keymapOnDesigner = [
                        new angular2_hotkeys__WEBPACK_IMPORTED_MODULE_4__["Hotkey"](["command+s", "ctrl+s"], function (e, s) {
                            _this.saveChatFlow();
                            return false;
                        }, [], "Save the chat flow"),
                        new angular2_hotkeys__WEBPACK_IMPORTED_MODULE_4__["Hotkey"](["command+r", "ctrl+r"], function (e, s) {
                            _this.playChatFlow();
                            return false;
                        }, [], "Run the chat"),
                        new angular2_hotkeys__WEBPACK_IMPORTED_MODULE_4__["Hotkey"]("n", function (e, s) {
                            _this.addNewNode();
                            return false;
                        }, [], "Add a new node"),
                        new angular2_hotkeys__WEBPACK_IMPORTED_MODULE_4__["Hotkey"]("c", function (e, s) {
                            _this.cloneSelectedNodes();
                            return false;
                        }, [], "Clone selected nodes"),
                        new angular2_hotkeys__WEBPACK_IMPORTED_MODULE_4__["Hotkey"]("esc", function (e, s) {
                            _this.clearSelection();
                            return false;
                        }, [], "Clear selection"),
                        new angular2_hotkeys__WEBPACK_IMPORTED_MODULE_4__["Hotkey"]("del", function (e, s) {
                            _this.deleteSelectedNodes();
                            return false;
                        }, [], "Delete selected nodes"),
                        new angular2_hotkeys__WEBPACK_IMPORTED_MODULE_4__["Hotkey"]("alt+f", function (e, s) {
                            _this.fitViewToAllNodes();
                            return false;
                        }, [], "Fit to screen"),
                        new angular2_hotkeys__WEBPACK_IMPORTED_MODULE_4__["Hotkey"]("alt+w", function (e, s) {
                            _this.gotoStartup();
                            return false;
                        }, [], "Close the designer")
                    ];
                ...
                ChatFlowComponent.prototype.deleteSelectedNodes = function () {
                    ...
                    if (selectedNodes.length == 1) {
                        ...
                        var name = this.MH.chatNodeAlias(selectedNode.chatNode);
                ...
                ChatFlowComponent.prototype.zoomToRectAnimIntermediate = function (x1, y1, width1, height1, x2, y2, width2, height2) {
                    var _this = this;
                    var step = Config.viewBoxAnimStep *
                        ((Math.abs(x1 - x2) +
                            Math.abs(y1 - y2) +
                ...
                ChatFlowComponent.prototype.designerWheel = function (event) {
                    ...
                    //cancel any ongoing animation as user might have interrupted it by doing the mouse down.
                    this.zoomCancel();
                    var change = Config.zoomCoefficient * event.deltaY;
                ...
                ChatFlowComponent.prototype.openEditor = function (chatNodeVM) {
                    var _this = this;
                    var dialogRef = this.dialog.open(_nodeeditor_nodeeditor_component__WEBPACK_IMPORTED_MODULE_16__["NodeEditorComponent"], {
                        width: "60%",
                ...
                ChatFlowComponent.prototype.layoutReady = function () {
                    if (!this.chatFlowNetwork.chatNodeVMs)
                        ...
                        return (this.chatFlowNetwork.chatNodeVMs.filter(function (x) { return x._layoutUpdated; }).length ==
                ...
                ChatFlowComponent.prototype.saveChatFlow = function () {
                    var nodeLocs = {};
                    for (var i = 0; i < this.chatFlowNetwork.chatNodeVMs.length; i++) {
                    ...
                    this.loginService.performLogin(false, null, true, function (done) {
                        ...
                        if (_this.dataService.loggedInUser) {
                            if (_this.dataService.isBizAdmin() || _this.dataService.isFlowManager()) {
                                _this.dialog.open(_shared_publish_chatbot_publish_chatbot_component__WEBPACK_IMPORTED_MODULE_15__["PublishChatbotComponent"], {
                                    width: "auto",
                                    data: {
                                        pack: _this.saveChatFlow(),
                                        bizId: _this.dataService.loggedInUser.businessId
                                    }
                                });
                            }
                            else {
                                var d = _this.dialog.open(_shared_business_picker_business_picker_component__WEBPACK_IMPORTED_MODULE_14__["BusinessPickerComponent"], {
                                    width: "30%",
                                    data: {
                                        askFlowId: false
                                    }
            ...
            ChatFlowComponent.ctorParameters = function () { return [
            ...
            var ChatFlowNetwork = /** @class */ (function () {
            ...
            var ChatNodeConnection = /** @class */ (function () {
                ...
                ChatNodeConnection.prototype.remove = function (event) {
                    ...
                    this.infoDialog.confirm("Delete connection?", "This will delete the connection between the button '" + (this
                        ...
                        "Unnamed Node") + "'. Are you sure?", function (ok) {
                        if (ok) {
            ...
            var ChatNodeNewConnection = /** @class */ (function () {
            ...
            var ChatButtonConnector = /** @class */ (function () {
                ...
                ChatButtonConnector.prototype.isConnected = function () {
                    ...
                    return (this.button.NextNodeId &&
                        this.chatNodeVM.network.chatNodeVMs.filter(function (x) { return x.chatNode.Id == _this.button.NextNodeId; }).length > 0);
                };
                return ChatButtonConnector;
            }());
            var ChatNodeVM = /** @class */ (function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NodeEditorComponent = /** @class */ (function () {
                function NodeEditorComponent(chatFlowService, hotkeys, infoDialog, dialogRef, chatNode, globalsService) {
                    ...
                    this.keymapOnNodeEditor = [
                        new angular2_hotkeys__WEBPACK_IMPORTED_MODULE_3__["Hotkey"](["t", "alt+t"], function (e, s) {
                            _this.addNewSectionText();
                            return false;
                        }, [], "Add a new text content (if applicable)"),
                        new angular2_hotkeys__WEBPACK_IMPORTED_MODULE_3__["Hotkey"](["b", "alt+b"], function (e, s) {
                            _this.addNewButton();
                            return false;
                        }, [], "Add a new button")
                    ];
                ...
                NodeEditorComponent.prototype.addNewSectionText = function () {
                    var _this = this;
                    if (this.contentTab) {
                        var newIndex = this.tabGroup._tabs
                            .toArray()
                            .findIndex(function (x) { return x.textLabel == _this.contentTab.textLabel; });
                        if (this.tabGroup.selectedIndex == newIndex) {
                            ...
                            setTimeout(function () {
                                requestAnimationFrame(function () {
                                    _this.MH.addSection(_this.chatNode, _models_chatflow_models__WEBPACK_IMPORTED_MODULE_4__["SectionType"].Text);
                                });
                            }, 500);
                        }
                    }
                ...
                NodeEditorComponent.prototype.addNewButton = function () {
                    ...
                    if (this.buttonsTab) {
                        var newIndex = this.tabGroup._tabs
                            .toArray()
                            .findIndex(function (x) { return x.textLabel == _this.buttonsTab.textLabel; });
                        if (this.tabGroup.selectedIndex == newIndex) {
            ...
            NodeEditorComponent.ctorParameters = function () { return [
                { type: _services_chatflow_service__WEBPACK_IMPORTED_MODULE_5__["ChatFlowService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SimulatorFrameComponent = /** @class */ (function () {
                function SimulatorFrameComponent(sanitizer) {
                    ...
                    var url = "https://simulator.chatbots.mn/?s=" + btoa(JSON.stringify(param));
            ...
            SimulatorFrameComponent.ctorParameters = function () { return [
                { type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["DomSanitizer"] }
            ]; };
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var StudioModule = /** @class */ (function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ModelHelpers = /** @class */ (function () {
                ...
                ModelHelpers.prototype.nodeDelete = function (chatNode, nodeEditor) {
                    ...
                    this.infoDialog.confirm("Sure?", "Are you sure you want to delete '" + (chatNode.Name ||
                        chatNode.NodeType) + "' chat node?", function (ok) {
                        if (ok) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AnalyticsWindowService = /** @class */ (function () {
                function AnalyticsWindowService(infoDialog) {
                    this.infoDialog = infoDialog;
                }
            ...
            AnalyticsWindowService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            var ChatFlowService = /** @class */ (function () {
            ...
            ChatFlowService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
            ]; };
            ...
            var GlobalsService = /** @class */ (function () {
                ...
                GlobalsService.prototype.uuidv4 = function () {
                    return ([1e7] + -1e3 + -4e3 + -8e3 + -1e11)
                        .toString()
                        .replace(/[018]/g, function (c) { return (c ^
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var InfoDialogService = /** @class */ (function () {
                ...
                InfoDialogService.prototype.alert = function (title, message, callback) {
                    ...
                    var d = this.dialog.open(_components_shared_info_dialog_info_dialog_component__WEBPACK_IMPORTED_MODULE_3__["InfoDialogComponent"], {
                        width: "auto",
                        data: data
                    });
                    if (callback)
            ...
            InfoDialogService.ctorParameters = function () { return [
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] }
            ]; };
                ...
                LoginService.prototype.performLogin = function (skipAuth, fallbackUrl, hardCheck, next) {
                    ...
                    this.dataService.userLoggedinCheck(function (loggedin) {
                        if (!loggedin && skipAuth == false) {
                            var d = _this.dialog.open(_components_shared_login_login_component__WEBPACK_IMPORTED_MODULE_4__["LoginComponent"], {
                                width: '600px',
                            });
                            d.afterClosed().subscribe(function (x) {
                                if (x == true) {
                ...
                SettingsService.prototype.listSavedChatProjectNames = function () {
                    ...
                    for (var key in localStorage) {
                        if (key.endsWith('.intelligo')) {
                            var name = key.replace(new RegExp('\.intelligo$'), '');
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SimulatorService = /** @class */ (function () {
                                ...
                                case _models_intelligo_chat_models__WEBPACK_IMPORTED_MODULE_5__["InputType"].LOCATION: //Click, Complex
                                    {
                                        ...
                                        var clickedBtn = this.getNodeButtonByType(_models_chatflow_models__WEBPACK_IMPORTED_MODULE_4__["ButtonType"].GetLocation);
                                        if (clickedBtn)
                                ...
                                case _models_intelligo_chat_models__WEBPACK_IMPORTED_MODULE_5__["InputType"].DATE: //Click, Complex
                                    {
                                        ...
                                        userData = ip.date;
                                        var clickedBtn = this.getNodeButtonByType(_models_chatflow_models__WEBPACK_IMPORTED_MODULE_4__["ButtonType"].GetDate);
                                        if (clickedBtn)
                                            nextNodeId = clickedBtn.NextNodeId;
                                    }
                                    break;
                                case _models_intelligo_chat_models__WEBPACK_IMPORTED_MODULE_5__["InputType"].TIME: //Click, Complex
                                    {
                                        var ip = ipMsgContent.input;
                                        userData = ip.time;
                                        var clickedBtn = this.getNodeButtonByType(_models_chatflow_models__WEBPACK_IMPORTED_MODULE_4__["ButtonType"].GetTime);
                                        if (clickedBtn)
                                            nextNodeId = clickedBtn.NextNodeId;
                                    }
                                    break;
                                case _models_intelligo_chat_models__WEBPACK_IMPORTED_MODULE_5__["InputType"].ADDRESS: //Click, Complex
                                    {
                                        var ip = ipMsgContent.input;
                                        userData = ip.address;
                                        var clickedBtn = this.getNodeButtonByType(_models_chatflow_models__WEBPACK_IMPORTED_MODULE_4__["ButtonType"].GetAddress);
                                        if (clickedBtn)
                                            nextNodeId = clickedBtn.NextNodeId;
                                    }
                                    break;
                                case _models_intelligo_chat_models__WEBPACK_IMPORTED_MODULE_5__["InputType"].MEDIA: //Click, Non Complex
                                    {
                                        ...
                                        if (ip.media && ip.media.length > 0 && ip.media[0]) {
                                            ...
                                            var cfmType = _models_chatflow_models__WEBPACK_IMPORTED_MODULE_4__["ButtonType"].GetFile;
                                ...
                                case _models_intelligo_chat_models__WEBPACK_IMPORTED_MODULE_5__["InputType"].OPTIONS: //Click, Non Complex
                                    {
                                        ...
                                        if (ip.val == "GET_STARTED") {
                                            var firstNode = underscore__WEBPACK_IMPORTED_MODULE_3__["first"](this.chatFlow.filter(function (x) { return x.IsStartNode; }));
                                ...
                                case _models_intelligo_chat_models__WEBPACK_IMPORTED_MODULE_5__["InputType"].LIST: //Click, Complex
                                    {
                                        ...
                                        var clickedBtn = this.getNodeButtonByType(_models_chatflow_models__WEBPACK_IMPORTED_MODULE_4__["ButtonType"].GetItemFromSource);
                                        if (clickedBtn)
                                            nextNodeId = clickedBtn.NextNodeId;
                                    }
                                    break;
                                case _models_intelligo_chat_models__WEBPACK_IMPORTED_MODULE_5__["InputType"].PHONE:
                                    {
                                        var ip = ipMsgContent.input;
                                        userData = ip.val;
                                        var clickedBtn = this.getNodeButtonByType(_models_chatflow_models__WEBPACK_IMPORTED_MODULE_4__["ButtonType"].GetPhoneNumber);
                                        if (clickedBtn)
                                            nextNodeId = clickedBtn.NextNodeId;
                                    }
                                    break;
                                case _models_intelligo_chat_models__WEBPACK_IMPORTED_MODULE_5__["InputType"].EMAIL:
                                    {
                                        var ip = ipMsgContent.input;
                                        userData = ip.val;
                                        var clickedBtn = this.getNodeButtonByType(_models_chatflow_models__WEBPACK_IMPORTED_MODULE_4__["ButtonType"].GetEmail);
                                        if (clickedBtn)
                                            nextNodeId = clickedBtn.NextNodeId;
                                    }
                                    break;
                                case _models_intelligo_chat_models__WEBPACK_IMPORTED_MODULE_5__["InputType"].NUMERIC:
                                    {
                                        var ip = ipMsgContent.input;
                                        userData = ip.val;
                                        var clickedBtn = this.getNodeButtonByType(_models_chatflow_models__WEBPACK_IMPORTED_MODULE_4__["ButtonType"].GetNumber);
                                        if (clickedBtn)
                                            nextNodeId = clickedBtn.NextNodeId;
                                    }
                                    break;
                                case _models_intelligo_chat_models__WEBPACK_IMPORTED_MODULE_5__["InputType"].TEXT:
                                    {
                                        var ip = ipMsgContent.input;
                                        userData = ip.val;
                                        var clickedBtn = this.getNodeButtonByType(_models_chatflow_models__WEBPACK_IMPORTED_MODULE_4__["ButtonType"].GetText);
                                        if (clickedBtn)
                                            nextNodeId = clickedBtn.NextNodeId;
                                    }
                                    break;
                ...
                SimulatorService.prototype.getNodeButtonByType = function (type) {
                    ...
                    if (type == _models_chatflow_models__WEBPACK_IMPORTED_MODULE_4__["ButtonType"].GetText) {
                        var found = underscore__WEBPACK_IMPORTED_MODULE_3__["first"](underscore__WEBPACK_IMPORTED_MODULE_3__["filter"](this.state.currentNode.Buttons, function (x) { return underscore__WEBPACK_IMPORTED_MODULE_3__["contains"]([
                ...
                SimulatorService.prototype.replaceTxt = function (subStr, key) {
                    ...
                    try {
                        if (this.state.variables && this.state.variables[key])
                            ...
                            var deepValue = jsonpath__WEBPACK_IMPORTED_MODULE_2__["query"](wrappedResp, key);
                ...
                SimulatorService.prototype.processNode = function (chatNode, section) {
                    ...
                    switch (chatNode.NodeType) {
                        case _models_chatflow_models__WEBPACK_IMPORTED_MODULE_4__["NodeType"].ApiCall:
                            {
                                var apiHeaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_8__["HttpHeaders"]();
                                if (chatNode.Headers) {
                                ...
                                var reqParams = new _angular_common_http__WEBPACK_IMPORTED_MODULE_8__["HttpParams"]();
                ...
                SimulatorService.prototype.convertSection = function (section) {
                    ...
                    switch (section.SectionType) {
                        ...
                        case _models_chatflow_models__WEBPACK_IMPORTED_MODULE_4__["SectionType"].Carousel:
                            {
                                var carContent = {
                                    items: underscore__WEBPACK_IMPORTED_MODULE_3__["map"](section.Items, function (x) {
                                        return {
                                            title: x.Title,
                                            desc: x.Caption,
                                            media: {
                                            ...
                                            options: underscore__WEBPACK_IMPORTED_MODULE_3__["map"](x.Buttons, function (y) {
                ...
                SimulatorService.prototype.convertButtons = function (chatNode, callback) {
                    var _this = this;
                    var clickInputs = underscore__WEBPACK_IMPORTED_MODULE_3__["filter"](chatNode.Buttons, function (x) { return underscore__WEBPACK_IMPORTED_MODULE_3__["contains"]([
                    ...
                    var textInputs = underscore__WEBPACK_IMPORTED_MODULE_3__["filter"](chatNode.Buttons, function (x) { return underscore__WEBPACK_IMPORTED_MODULE_3__["contains"]([
                    ...
                    if (clickInputs && clickInputs.length > 0) {
                        if (underscore__WEBPACK_IMPORTED_MODULE_3__["filter"](clickInputs, function (x) { return underscore__WEBPACK_IMPORTED_MODULE_3__["contains"]([_models_chatflow_models__WEBPACK_IMPORTED_MODULE_4__["ButtonType"].NextNode, _models_chatflow_models__WEBPACK_IMPORTED_MODULE_4__["ButtonType"].OpenUrl], x.ButtonType); }).length > 0) { //If next node/open url button is present, only options can be sent
                            //Build options input and send
                            var optionsInput = {
                                inputType: _models_intelligo_chat_models__WEBPACK_IMPORTED_MODULE_5__["InputType"].OPTIONS,
                                mandatory: mandatory,
                                options: underscore__WEBPACK_IMPORTED_MODULE_3__["map"](underscore__WEBPACK_IMPORTED_MODULE_3__["filter"](clickInputs, function (x) { return underscore__WEBPACK_IMPORTED_MODULE_3__["contains"]([_models_chatflow_models__WEBPACK_IMPORTED_MODULE_4__["ButtonType"].NextNode, _models_chatflow_models__WEBPACK_IMPORTED_MODULE_4__["ButtonType"].OpenUrl], x.ButtonType); }), function (y) {
                                    return {
                        ...
                        var inputButton_1 = underscore__WEBPACK_IMPORTED_MODULE_3__["first"](clickInputs);
                    ...
                    try {
                        if (chatNode.Buttons) {
                            for (var btnIdx = 0; btnIdx < chatNode.Buttons.length; btnIdx++) {
                                ...
                                var wrappedResp = {};
                                wrappedResp[rootToken] = JSON.parse(this.state.variables[rootToken]);
                                var deepValue = jsonpath__WEBPACK_IMPORTED_MODULE_2__["query"](wrappedResp, btn.ConditionMatchKey);
                                if (deepValue && typeof deepValue == 'object' && deepValue.length == 1) {
                                    deepValue = deepValue[0];
                                }
            ...
            SimulatorService.ctorParameters = function () { return [
