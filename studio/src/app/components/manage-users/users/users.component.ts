...
import {
  ...
  UserDialogMode,
  UserDialogParam,
} from '../../shared/create-user/create-user.component';
...
export class UsersComponent implements OnInit, AfterViewInit {
  ...
  loadBusinessDetails() {
    ...
    this.dataService.getBusinessDetails(this.bizId).subscribe(
      x => {
      ...
      err => {
        ...
        this.dataService.handleError(
          ...
          'Something went wrong while trying to load business account details. Please try again.',
        );
      },
    );
  }
  ...
  loadUsers() {
    if (this.bizId) {
      this.infoDialog.showSpinner();
      this.dataService.getUsers(this.bizId, this.search, this.page).subscribe(
        x => {
          this.infoDialog.hideSpinner();
          //if (x.success) {
