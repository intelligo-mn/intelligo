...
import * as models from "./chat.models";
    ...
    switch (inputVM.content.inputType) {
      ...
      case models.InputType.TIME: {
        ...
        dialogRef.afterClosed().subscribe(result => {
          ...
          let userInputTime = dialogRef.componentInstance.getChoosenIntelligoTime();
      ...
      case models.InputType.DATE: {
        ...
        dialogRef.afterClosed().subscribe(result => {
          ...
          let userInputDate = dialogRef.componentInstance.getChoosenIntelligoDate();
